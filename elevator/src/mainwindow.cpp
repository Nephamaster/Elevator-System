...
{
    int mode = 1;//设置算法模式(0-Bus,1-scan,2-look)
    ...
    //this->setStyleSheet("background-color: rgb(22,218,208, 100);");
    ui->lineEdit_id->setStyleSheet("font: 20 10pt '微软雅黑 Light';" //字体
                                    "color: rgb(31,31,31);"		//字体颜色
                                    "padding-left:15px;"       //内边距-字体缩进
                                    "background-color: rgb(255, 255, 255);" //背景颜色
                                    "border:2px solid rgb(20,196,188);border-radius:10px;");//边框粗细-颜色-圆角设置
    ui->lineEdit_weight->setStyleSheet("font: 20 10pt '微软雅黑 Light';" //字体
                                     "color: rgb(31,31,31);"		//字体颜色
                                     "padding-left:15px;"       //内边距-字体缩进
                                     "background-color: rgb(255, 255, 255);" //背景颜色
                                     "border:2px solid rgb(20,196,188);border-radius:10px;");//边框粗细-颜色-圆角设置
    ui->lineEdit_currentfloor->setStyleSheet("font: 20 10pt '微软雅黑 Light';" //字体
                                             "color: rgb(31,31,31);"		//字体颜色
                                             "padding-left:15px;"       //内边距-字体缩进
                                             "background-color: rgb(255, 255, 255);" //背景颜色
                                             "border:2px solid rgb(20,196,188);border-radius:10px;");//边框粗细-颜色-圆角设置
    ui->lineEdit_destinationfloor->setStyleSheet("font: 20 10pt '微软雅黑 Light';" //字体
                                                 "color: rgb(31,31,31);"		//字体颜色
                                                 "padding-left:15px;"       //内边距-字体缩进
                                                 "background-color: rgb(255, 255, 255);" //背景颜色
                                                 "border:2px solid rgb(20,196,188);border-radius:10px;");//边框粗细-颜色-圆角设置
    ui->pushButton->setStyleSheet("QPushButton{font: 20 10pt '微软雅黑 Light';color: rgb(255,255,255);background-color: rgb(20,196,188);"
                                  "border: none;border-radius:15px;}"
                                  "QPushButton:hover{background-color: rgb(22,218,208);}"//hover
                                  "QPushButton:pressed{background-color: rgb(17,171,164);}");//pressed
    ui->pushButton->setText("Submit");

    ui->label->setStyleSheet("background-color:rgb(248,248,255);");
    ui->label_2->setStyleSheet("background-color:rgb(248,248,255);");
    ui->label_3->setStyleSheet("background-color:rgb(248,248,255);");
    ui->label_4->setStyleSheet("background-color:rgb(248,248,255);");
    ui->label_5->setStyleSheet("background-color:rgb(248,248,255);border:2px solid rgb(248,248,255);border-radius:10px;");
    ...
    string str1 = "结对项目-电梯调度系统(0-Bus,1-scan,2-look):";
